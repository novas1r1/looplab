...
class AllSongsStatusMapper extends EnumMapper<AllSongsStatus> {
  ...
  AllSongsStatus decode(dynamic value) {
    switch (value) {
      ...
      case r'errorAudioFormat':
        return AllSongsStatus.errorAudioFormat;
      case r'errorVideoFormat':
        return AllSongsStatus.errorVideoFormat;
      case r'errorImportInProgress':
        return AllSongsStatus.errorImportInProgress;
      default:
...
class AllSongsStateMapper extends ClassMapperBase<AllSongsState> {
  ...
  static const Field<AllSongsState, AllSongsStatus> _f$status = Field(
    'status',
    _$status,
    opt: true,
    def: AllSongsStatus.initial,
  );
  static List<Song> _$songs(AllSongsState v) => v.songs;
  static const Field<AllSongsState, List<Song>> _f$songs = Field(
    'songs',
    _$songs,
    opt: true,
    def: const [],
  ...
  static const Field<AllSongsState, String> _f$errorMessage = Field(
    'errorMessage',
    _$errorMessage,
    opt: true,
  );
