...
mixin FetchProductsStateMappable {
  ...
  FetchProductsStateCopyWith<
    FetchProductsState,
    FetchProductsState,
    FetchProductsState
  >
  get copyWith =>
      _FetchProductsStateCopyWithImpl<FetchProductsState, FetchProductsState>(
  ...
  @override
  String toString() {
    return FetchProductsStateMapper.ensureInitialized().stringifyValue(
      this as FetchProductsState,
    );
  }
  ...
  @override
  int get hashCode {
    return FetchProductsStateMapper.ensureInitialized().hashValue(
      this as FetchProductsState,
    );
  }
}
...
abstract class FetchProductsStateCopyWith<
  $R,
  $In extends FetchProductsState,
  $Out
>
