...
class PaywallCubit extends Cubit<PaywallState> {
  ...
  Future<void> init() async {
    ...
    if (Platform.isAndroid) {
      configuration =
          PurchasesConfiguration('goog_NhdNoPthClDEMfKSoFnpljqybdX');
    } else if (Platform.isIOS) {
      configuration =
          PurchasesConfiguration('appl_sUAEypMdINdSIzcVlkUWvVZPjlN');
    }
  ...
  Future<void> showPaywall() async {
    ...
    try {
      final paywallResult = await paywallRepository.presentPaywallIfNeeded();
