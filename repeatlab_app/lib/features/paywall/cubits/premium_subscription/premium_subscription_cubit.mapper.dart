  ...
  static PremiumSubscriptionStateMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = PremiumSubscriptionStateMapper._());
    }
    return _instance!;
  }
...
mixin PremiumSubscriptionStateMappable {
  ...
  String toString() {
    return PremiumSubscriptionStateMapper.ensureInitialized()
        .stringifyValue(this as PremiumSubscriptionState);
  }

  @override
  bool operator ==(Object other) {
    return PremiumSubscriptionStateMapper.ensureInitialized()
        .equalsValue(this as PremiumSubscriptionState, other);
  }

  @override
  int get hashCode {
    return PremiumSubscriptionStateMapper.ensureInitialized()
        .hashValue(this as PremiumSubscriptionState);
  }
}
