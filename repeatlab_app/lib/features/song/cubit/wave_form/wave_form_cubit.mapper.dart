...
class WaveFormStateMapper extends ClassMapperBase<WaveFormState> {
  ...
  static const Field<WaveFormState, WaveFormStateStatus> _f$status =
      Field('status', _$status, opt: true, def: WaveFormStateStatus.loading);
  static Float32List? _$waveformData(WaveFormState v) => v.waveformData;
  static const Field<WaveFormState, Float32List> _f$waveformData =
      Field('waveformData', _$waveformData, opt: true);
  static Duration _$duration(WaveFormState v) => v.duration;
  static const Field<WaveFormState, Duration> _f$duration =
      Field('duration', _$duration, opt: true, def: Duration.zero);
  ...
  static const Field<WaveFormState, Duration> _f$currentPosition = Field(
      ...
      opt: true, def: Duration.zero);
  static double _$waveformWidth(WaveFormState v) => v.waveformWidth;
  static const Field<WaveFormState, double> _f$waveformWidth =
      Field('waveformWidth', _$waveformWidth, opt: true, def: 0.0);
  static double _$screenWidth(WaveFormState v) => v.screenWidth;
  static const Field<WaveFormState, double> _f$screenWidth =
      Field('screenWidth', _$screenWidth, opt: true, def: 0.0);
  static List<Loop> _$loops(WaveFormState v) => v.loops;
  static const Field<WaveFormState, List<Loop>> _f$loops =
      Field('loops', _$loops, opt: true, def: const []);
  static Exception? _$error(WaveFormState v) => v.error;
  static const Field<WaveFormState, Exception> _f$error =
...
mixin WaveFormStateMappable {
  String toJson() {
    return WaveFormStateMapper.ensureInitialized()
        .encodeJson<WaveFormState>(this as WaveFormState);
  }

  Map<String, dynamic> toMap() {
    return WaveFormStateMapper.ensureInitialized()
        .encodeMap<WaveFormState>(this as WaveFormState);
  }
  ...
  WaveFormStateCopyWith<WaveFormState, WaveFormState, WaveFormState>
      get copyWith => _WaveFormStateCopyWithImpl<WaveFormState, WaveFormState>(
          this as WaveFormState, $identity, $identity);
  @override
  String toString() {
    return WaveFormStateMapper.ensureInitialized()
        .stringifyValue(this as WaveFormState);
  }

  @override
  bool operator ==(Object other) {
    return WaveFormStateMapper.ensureInitialized()
        .equalsValue(this as WaveFormState, other);
  }

  @override
  int get hashCode {
    return WaveFormStateMapper.ensureInitialized()
        .hashValue(this as WaveFormState);
  }
}
