...
import 'package:repeatlab/features/song/widgets/audio_waveform_painter.dart';
...
class _AudioWaveformWidgetState extends State<AudioWaveformWidget> {
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    ...
    final maxScroll = widget.waveform.length.toDouble() * _zoomScale;
  ...
  Widget build(BuildContext context) {
    ...
    final waveformWidth = widget.waveform.length.toDouble() * _zoomScale;
