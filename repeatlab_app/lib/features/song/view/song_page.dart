...
class _SongViewState extends State<_SongView> with WidgetsBindingObserver {
    ...
    return MultiBlocListener(
      ...
      child: BlocSelector<SongCubit, SongState, SongStatus>(
        ...
        builder: (context, status) =>
            FadeThroughSwitcher(child: _buildScaffold(context, status)),
      ),
    );
  }

  Widget _buildScaffold(BuildContext context, SongStatus status) {
    switch (status) {
      case SongStatus.loading:
        return const Scaffold(
          key: Key('song.loading'),
          body: Center(child: Loading()),
        );
      case SongStatus.loadError:
        return Scaffold(
          key: const Key('song.loadError'),
          appBar: AppBar(
                                    ...
                                    Widget buildItem(
                                      ...
                                      child: LoopTile(
                                        ...
                                        onDelete: (loop) {
                                          ...
                                          context.read<SongCubit>().deleteLoop(
                                            loop,
                                          );
                                        },
                                        onPlay: (loop) {
                                        ...
                                        onUpdate: (loop) {
                                          ...
                                          context.read<SongCubit>().updateLoop(
                                            loop,
                                          );
                                        },
  ...
  Future<void> _onTapDeleteSong(BuildContext context) async {
    ...
    final result = await DialogHelper.showAnimated<bool>(
      context,
                      ...
                      onPressed: titleController.text.trim().isEmpty
                          ...
                          : () {
                              ...
                              Navigator.of(dialogContext).pop((
                                ...
                                bpm: bpm,
                                musicalKey: selectedKey.isEmpty
                                    ? null
                                    : selectedKey,
                              ));
                            },
